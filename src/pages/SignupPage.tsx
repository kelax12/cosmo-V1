...
const InputField = memo<InputFieldProps>(({ label, type, value, onChange, placeholder, testId }) => (
  <div>
...
const SignupPage: React.FC = () => {
  ...
  const { register, loginWithGoogle, loginAsDemo, isSupabaseConfigured } = useAuth();
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4" data-testid="signup-page">
      <div className="w-full max-w-md bg-slate-900 border border-slate-800 rounded-2xl p-8 shadow-2xl">
        ...
        <p className="text-slate-400 text-center mb-6">Créez votre compte pour commencer</p>
        ...
        <button
          ...
          className="w-full mb-4 bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 text-white font-semibold py-3 rounded-xl transition-all flex items-center justify-center gap-2"
